...
export default function DashboardPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            {/* BRAND PRIMARY WELCOME BANNER */}
            <div className="bg-primary text-white rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-xl shadow-primary/20 relative overflow-hidden">
                ...
                <Link
                    href="/iibi"
                    className="relative z-10 px-5 py-3 bg-white text-primary font-extrabold rounded-xl text-xs md:text-sm hover:bg-slate-100 transition flex items-center gap-2 shadow-lg shrink-0"
                >
                    <ShoppingCart className="w-4 h-4 text-primary" /> Open POS Terminal
                </Link>
            </div>
                ...
                <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-4">
                    <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                        <h2 className="font-bold text-slate-900 dark:text-white text-base flex items-center gap-2">
                            <ShoppingCart className="w-4 h-4 text-primary" /> Recent Transactions
                        </h2>
                        <Link
                            href="/ganacsi"
